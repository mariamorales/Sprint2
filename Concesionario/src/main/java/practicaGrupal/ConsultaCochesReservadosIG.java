...
/*
 * ConsultaCochesReservadosIG.java
 *
 * Created on 13-dic-2011, 20:26:13
 */
...
public class ConsultaCochesReservadosIG extends javax.swing.JDialog {

    private ArrayList<CocheConcesionario> misCochesC =
            new ArrayList<CocheConcesionario>();
    /** Creates new form ConsultaCochesReservadosIG */
    public ConsultaCochesReservadosIG(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultaCochesReservadosIG.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                ConsultaCochesReservadosIG dialog = new ConsultaCochesReservadosIG(new javax.swing.JFrame(), true);
    ...
    public void cargarCochesReservados() {
        ...
        for (int i = 0; i < this.misCochesC.size(); i++) {
            if ((misCochesC.get(i).getEstado().equalsIgnoreCase("Reservado"))) {
