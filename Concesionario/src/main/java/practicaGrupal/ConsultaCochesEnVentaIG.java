...
/*
 * ConsultaCochesEnVentaIG.java
 *
 * Created on 13-dic-2011, 20:25:49
 */
package practicaGrupal;
import java.util.ArrayList;
import javax.swing.table.DefaultTableModel;

public class ConsultaCochesEnVentaIG extends javax.swing.JDialog {
     private ArrayList<CocheConcesionario> misCochesC =
            new ArrayList<CocheConcesionario>();
    /** Creates new form ConsultaCochesEnVentaIG */
    public ConsultaCochesEnVentaIG(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultaCochesEnVentaIG.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                ConsultaCochesEnVentaIG dialog = new ConsultaCochesEnVentaIG(new javax.swing.JFrame(), true);
    ...
    // End of variables declaration//GEN-END:variables
        ...
        public void cargarCochesEnVenta() {
